...
public class NotificationAdapter extends RecyclerView.Adapter<NotificationAdapter.MyViewHolder> {
    ...
    public NotificationAdapter(List<Info> infoList) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        Info movie = infoList.get(position);
//        if(!TextUtils.isEmpty(movie.getNotificationText())) {
//            holder.tv_notification_details.setText(movie.getNotificationText());
//        }

        if(!TextUtils.isEmpty(movie.getCreatedOn())) {

            holder.tv_daystatus.setText(movie.getCreatedOn());
        }
        if(!TextUtils.isEmpty(movie.getNotificationType())) {

            holder.title.setText(movie.getNotificationText());
        }
    }
